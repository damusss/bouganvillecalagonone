...
def make_circle(surf: pygame.Surface):
    ...
    medium.fill(0)
    pygame.draw.circle(medium, "white", (medium.width/2, medium.height/2), medium.height/2)
    surf.blit(medium, special_flags=pygame.BLEND_RGBA_MULT)
    # pygame.draw.circle(surf, (0,0,0,255), (medium.width/2, medium.height/2), medium.width/2, int(SIZE*0.02))
    return surf
...
def get_en():
    ...
    pygame.draw.line(surf, white, (0-displacement, 0), (SIZE+displacement, SIZE), dg_w)
    pygame.draw.line(surf, white, (0-displacement, SIZE), (SIZE+displacement, 0), dg_w)
    pygame.draw.line(surf, red, (0-displacement, 0), (SIZE+displacement, SIZE), dg_r)
    pygame.draw.line(surf, red, (0-displacement, SIZE), (SIZE+displacement, 0), dg_r)

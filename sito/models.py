...
class Apartment(models.Model):
    ...
    name_it = models.CharField("Nome Appartamento (in italiano)", max_length=1000, default="")
    name_en = models.CharField("Nome Appartamento (in inglese)", max_length=1000, default="")
    ...
    max_people = models.CharField("Numero Massimo Persone", max_length=1000, default="5")
...
class Labels(models.Model):
    ...
    page_title_home_it = models.CharField("Titolo Pagina home (IT)", max_length=1000, default="")
    page_title_home_en = models.CharField("Titolo Pagina home (EN)", max_length=1000, default="")
    page_title_calagonone_it = models.CharField("Titolo Pagina calagonone (IT)", max_length=1000, default="")
    page_title_calagonone_en = models.CharField("Titolo Pagina calagonone (EN)", max_length=1000, default="")
    page_title_contacts_it = models.CharField("Titolo Pagina contacts (IT)", max_length=1000, default="")
    page_title_contacts_en = models.CharField("Titolo Pagina contacts (EN)", max_length=1000, default="")
    page_title_apartment_it = models.CharField("Titolo Pagina apartment (IT)", max_length=1000, default="")
    page_title_apartment_en = models.CharField("Titolo Pagina home (EN)", max_length=1000, default="")

    section_home_it = models.CharField("Etichetta Sezione home (IT)", max_length=1000, default="")
    section_home_en = models.CharField("Etichetta Sezione home (EN)", max_length=1000, default="")
    section_calagonone_it = models.CharField("Etichetta Sezione calagonone (IT)", max_length=1000, default="")
    section_calagonone_en = models.CharField("Etichetta Sezione calagonone (EN)", max_length=1000, default="")
    section_contacts_it = models.CharField("Etichetta Sezione contacts (IT)", max_length=1000, default="")
    section_contacts_en = models.CharField("Etichetta Sezione contacts (EN)", max_length=1000, default="")

    location_directions_it = models.CharField("Etichetta Come Arrivare (IT)", max_length=1000, default="")
    location_directions_en = models.CharField("Etichetta Come Arrivare (EN)", max_length=1000, default="")
    view_apartments_it = models.CharField("Etichetta per 'guarda gli appartamenti' (IT)", max_length=1000, default="")
    view_apartments_en = models.CharField("Etichetta per 'guarda gli appartamenti' (EN)", max_length=1000, default="")
    book_it = models.CharField("Etichetta per 'prenota' (IT)", max_length=1000, default="")
    book_en = models.CharField("Etichetta per 'prenota' (EN)", max_length=1000, default="")
    details_it = models.CharField("Etichetta per 'dettagli appartamento' (IT)", max_length=1000, default="")
    details_en = models.CharField("Etichetta per 'dettagli appartamento' (EN)", max_length=1000, default="")

    quick_book_it = models.CharField("Titolo sezione 'prenota' (info e contatti) (IT)", max_length=1000, default="")
    quick_book_en = models.CharField("Titolo sezione 'prenota' (info e contatti) (EN)", max_length=1000, default="")
    contacts_it = models.CharField("Titolo sezione 'contatti' (info e contatti) (IT)", max_length=1000, default="")
    contacts_en = models.CharField("Titolo sezione 'contatti' (info e contatti) (EN)", max_length=1000, default="")
    ...
    form_apartment_it = models.CharField("'scegli appartamento' Form (IT)", max_length=1000, default="")
    form_apartment_en = models.CharField("'scegli appartamento' Form (EN)", max_length=1000, default="")
    ...
    form_children_it = models.CharField("Bambini Form (IT)", max_length=1000, default="")
    form_children_en = models.CharField("Bambini Form (EN)", max_length=1000, default="")
    form_people_it = models.CharField("'Persone' Form (IT)", max_length=1000, default="")
    form_people_en = models.CharField("'Persone' Form (EN)", max_length=1000, default="")
    ...
    form_email_ph_it = models.CharField("Placeholder Email Form (IT)", max_length=1000, default="")
    form_email_ph_en = models.CharField("Placeholder Email Form (EN)", max_length=1000, default="")
    form_phone_ph_it = models.CharField("Placeholder Phone Form (IT)", max_length=1000, default="")
    form_phone_ph_en = models.CharField("Placeholder Phone Form (EN)", max_length=1000, default="")
    form_message_ph_it = models.CharField("Placeholder Message Form (IT)", max_length=1000, default="")
    form_message_ph_en = models.CharField("PlaceholderMessage Form (EN)", max_length=1000, default="")
    
    prices_it = models.CharField("Etichetta 'prezzi e condizioni' (IT)", max_length=1000, default="")
    prices_en = models.CharField("Etichetta 'prezzi e condizioni' (EN)", max_length=1000, default="")
    ...
    cancelation_it = models.CharField("Etichetta 'cancellazione' (IT)", max_length=1000, default="")
